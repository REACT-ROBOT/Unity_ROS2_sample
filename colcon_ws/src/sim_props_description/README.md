...
| `gnss_canyon` | GNSS の劣化 (`gnss_sky_view` / `gnss`) | 幅 8 m・高さ 10 m のビル街 (x=4〜26、横道 2 本) |
...
(雑草や磁気テープはトリガなので、既定では衛星を遮りません)。街路は幅 8 m・
壁高 10 m で、途中に 2 m の横道が 2 本あります。そこを通るたびに空が開けるので、
測位品質が一度回復する様子が見られます。

壁を高く / 街路を狭くするほど劣化は強くなり、反射 (NLOS) の余分な行程も伸びます。
